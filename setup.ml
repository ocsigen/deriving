...
(* OASIS_START *)
(* DO NOT EDIT (digest: 564c51ac3b73ea9df9a30b81e289b131) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "lib";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "deriving-runtime"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "deriving-runtime";
                           InternalLibrary "pa_deriving_classes";
                           InternalLibrary "pa_deriving_tc"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "deriving";
                      lib_findlib_name = Some "deriving_tc";
                      lib_findlib_containers = []
                   });
               Library
                 ({
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "|[p½\136¼\r\134ÙG×c\150dË\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
